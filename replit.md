...
- **Lead Management:** Kanban-style pipeline with activity timelines, follow-up scheduling, and conversion flows. Public lead capture form at `/join/:gymSlug` (no auth required) with auto source="website", case-insensitive gym-scoped dedup, and activity logging.
